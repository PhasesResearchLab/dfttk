...
def test_process_debye():
    ...
    assert np.allclose(debye.helmholtz_energies, expected_debye.helmholtz_energies, rtol=1e-3), f"Expected {expected_debye.helmholtz_energies}, but got {debye.helmholtz_energies}"
