...
#TODO: Figure out a more efficient function
...
def process_quasi_harmonic(
    ...
    for temperature in temperature_list:
        ...
        if debye_properties is not None and harmonic_properties_fit is None:
            ...
            volume_range_debye = debye_properties[debye_properties["temperatures"] == temperature]["volume"].values[0]
            ...
            f_vib = debye_properties[debye_properties["temperatures"] == temperature]["f_vib"].values[0]
        ...
        if debye_properties is not None:
            s_vib = debye_properties[debye_properties["temperatures"] == temperature]["s_vib"].values[0]
            s = s_vib
            order = 2
